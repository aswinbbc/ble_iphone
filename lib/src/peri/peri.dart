...
class FlutterBlePeripheralExampleState
  ...
  final AdvertiseData advertiseData = AdvertiseData(
    ...
    localName:
        'GWatch mijkjjihjygjyjyjttfdtdtftdhtfhtftdftftftftyftyftytrfytryryrytrytrtyrtyrtrttwuydeqtwyysdgjasghjasgdhasgdhsadgahsdgjahsdgajhsdghhhfhm',
    serviceUuid: '0000180D-0000-1000-8000-00805F9B34FB',
    manufacturerId: 1234,
    manufacturerData: galaxyWatchData,
    serviceDataUuid: '0000180D-0000-1000-8000-00805F9B341B',
    serviceData: galaxyWatchData,
  );

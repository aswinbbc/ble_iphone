...
import 'package:flutter_reactive_ble_example/src/peri/peri.dart';
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => FlutterBlePeripheralExample(),
                      ));
                },
                child: Text('create'))
          ],
                      ...
                      .map(
                        (device) => ListTile(
                          ...
                          subtitle: Text(
                            ...
                            ${device.serviceUuids.map((e) => e.data).toSet().toString()}
                            ${device.manufacturerData.toSet().toString()} ${device.serviceData.entries.toSet().toString()}
                            RSSI: ${device.rssi}
                            ${device.connectable}
                            """,
                          ),
